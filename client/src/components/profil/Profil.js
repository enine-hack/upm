...
const Profil = (props) => {
    return(
        ...
        <Container style={{ width: "650px" }}>
          ...
          <form>
          <p style={{ paddingLeft: "30px", textAlign: "left" }}><b>MODIFY MY CONNECTION DATA</b></p>
            <Col>
              <input style={{ width: "650px", paddingLeft: "15px", paddingBottom:"6px", marginBottom: "40px", borderStyle: "none none solid none", borderWidth: "1px", borderColor: "#E5E5E5" }}
            ...
            <p style={{ paddingLeft: "30px", textAlign: "left" }}> Fill out your profile and directly benefit from all the advantages linked to your loyalty accounts.</p>

            <Col>
              <input style={{ width: "650px", paddingLeft: "15px", paddingBottom:"6px", marginBottom: "30px", borderStyle: "none none solid none", borderWidth: "1px", borderColor: "#E5E5E5" }}
            ...
            <Col><input style={{ width: "650px", height: "45px", border: "none", backgroundColor: "#1a1a1a", color: "white" }} type="submit" value="LOG IN" /></Col>
          </form>
        </Row>
